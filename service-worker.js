...
var filesToCache = [
    ...
    '/addressbook/scripts/app.js',
    '/addressbook/scripts/bootstrap.bundle.min.js',
    '/addressbook/scripts/vue.min.js',
    '/addressbook/scripts/all.min.js',
    '/addressbook/styles/inline.css',
    '/addressbook/styles/bootstrap.min.css'
];
